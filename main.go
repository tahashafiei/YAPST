...
func handleHome(w http.ResponseWriter, r *http.Request) {
	...
	render(w, r, "home", PageData{Title: siteConfig.Name, Active: "home"})
}
...
func handleWriting(w http.ResponseWriter, r *http.Request) {
	...
	render(w, r, "writing", PageData{Title: "Writing | " + siteConfig.Name, Active: "writing", Posts: posts})
}
...
func handlePost(w http.ResponseWriter, r *http.Request) {
	...
	render(w, r, "post", PageData{Title: post.Title + " | " + siteConfig.Name, Active: "writing", Post: post})
}

func handleMisc(w http.ResponseWriter, r *http.Request) {
	render(w, r, "misc", PageData{Title: "Misc | " + siteConfig.Name, Active: "misc"})
}
